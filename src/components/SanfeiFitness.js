...
class SanfeiFitness extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
  ...
  <nav aria-label="breadcrumb" className="breadcrumb-nav">
    <div className="container">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active" aria-current="page">Sanfei Fitness</li>
      </ol>
    </div>
  </nav>
  <div className="container">
    <div className="row">
      <div className="col-lg-12">
        <div className="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light">
          <div className="category-slide">
            ...
            <div className="banner boxed-slide-content offset-1">
              <h2 className="banner-subtitle" style={{color:'white'}}>check out over <span>10+</span></h2>
              <h1 className="banner-title" style={{color:'white'}}>
                Featured Gym Equipments
              </h1>
        ...
        <h1 className="mt-5 text-center">NH SELECTORIZED</h1>
        ...
        {this.props.NH.map((nh)=>
                   <div className="product-default inner-quickview inner-icon center-details" key={nh.id}>
                   <figure>
                     <a href="product.html">
                       <img src={nh.image}/>
                     </a>
                   ...
                   <div className="product-details">
                     <div className="category-wrap">
                       <div className="category-list">
                         <a href="category.html" className="product-category">{nh.sub_category}</a>
                       </div>
                     </div>
                     <h2 className="product-title">
                       <a href="product.html">{nh.name}</a>
                     </h2>
        ...
        <h1 className="mt-5 text-center">NC SELECTORIZED</h1>
        <div className="mt-5 row row-sm">
        <div className="owl-carousel owl-theme" data-toggle="owl" data-owl-options="{
                          'margin': 4,
                          'items': 2,
        ...
        {this.props.NC.map((nc)=>
                   <div className="product-default inner-quickview inner-icon center-details" key={nc.id}>
                   <figure>
                     <a href="product.html">
                       <img src={nc.image}/>
                     </a>
                   ...
                   <div className="product-details">
                     <div className="category-wrap">
                       <div className="category-list">
                         <a href="category.html" className="product-category">{nc.sub_category}</a>
                       </div>
                     </div>
                     <h2 className="product-title">
                       <a href="product.html">{nc.name}</a>
                     </h2>
                   </div>{/* End .product-details */}
                 </div>
)}
        ...
        <h1 className="mt-5 text-center">TH SELECTORIZED</h1>
        <div className="mt-5 row row-sm">
        <div className="owl-carousel owl-theme" data-toggle="owl" data-owl-options="{
                          'margin': 4,
                          'items': 2,
        ...
        <h1 className="mt-5 text-center">TH/PT PLATE LOADED</h1>
        <div className="mt-5 row row-sm">
        <div className="owl-carousel owl-theme" data-toggle="owl" data-owl-options="{
                          'margin': 4,
                          'items': 2,
