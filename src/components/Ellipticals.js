  ...
  <nav aria-label="breadcrumb" className="breadcrumb-nav">
    <div className="container">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active" aria-current="page">Ellipticals</li>
      </ol>
    </div>
  </nav>
  <div className="container">
    <div className="row">
      <div className="col-lg-12">
        ...
        <h1 className="mt-5 text-center">Featured ellipticals</h1>
        <div className="mt-5 row row-sm">
        {this.props.ellipticals.map((elliptical)=>
          <div className="col-6 col-md-4 col-xl-3" key={elliptical.id}>
            <div className="product-default inner-quickview inner-icon">
              <figure>
                <a href="product.html">
                  <img src={elliptical.image} />
                </a>
              ...
              <div className="product-details ">
                <div className="category-wrap">
                  <div className="category-list">
                    <a href="category.html" className="product-category">{elliptical.sub_category}</a>
                  </div>
                </div>
                <h2 className="product-title">
                  <a href="product.html">{elliptical.name}</a>
                </h2>
